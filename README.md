...
> [!NOTE]
> The dataset is available on [Kaggle](https://www.kaggle.com/datasets/grimespoint/fallout-new-vegas-dataset) with an exploratory [notebook](https://www.kaggle.com/code/grimespoint/fallout-new-vegas-dataset-exploration) and in the Kaggle [archive repository](https://github.com/hyperphantasia/kaggle).
